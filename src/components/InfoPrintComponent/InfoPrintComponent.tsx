        ...
        <table className="tbl-info-product">
          <tbody>
            ...
            <tr>
              ...
              <td className="attribute-value highlight">
                <Form.Item
                  name="location_warranty"
                  initialValue={defaultValue.locationWarranty || ''}
                >
                  <Input maxLength={maxLength} showCount width={'100%'} />
                </Form.Item>
              </td>
            ...
            <tr>
              ...
              <td className="attribute-value ">
                <Form.Item
                  name="category_printer"
                  initialValue={defaultValue.categoryPrinter || ''}
                >
                  <Input maxLength={maxLength} showCount width={'100%'} />
                </Form.Item>
              </td>
            ...
            <tr>
              ...
              <td className="attribute-value highlight">
                <Form.Item
                  name="speed_print_black_white"
                  initialValue={defaultValue.speedPrintBlackWhite || ''}
                >
                  <Input maxLength={maxLength} showCount width={'100%'} />
                </Form.Item>
              </td>
            ...
            <tr>
              ...
              <td className="attribute-value ">
                <Form.Item
                  name="speed_print_color"
                  initialValue={defaultValue.speedPrintColor || ''}
                >
                  <Input maxLength={maxLength} showCount width={'100%'} />
                </Form.Item>
              </td>
            ...
            <tr>
              ...
              <td className="attribute-value highlight">
                <Form.Item
                  ...
                  initialValue={defaultValue.internetConnect || ''}
                >
                  <Input maxLength={maxLength} showCount width={'100%'} />
                </Form.Item>
              </td>
