      ...
      <Form className="d-flex w-100">
        <div className="w-50">
          <div className="form-group--left">
            <div className="background-content">
              <label>
                Logo top | <span className="highlight">530</span>px x{' '}
                <span className="highlight">285</span>px
              </label>
              <div className="form-group--nest">
                <ImageUploadSingle
                  styleClassName="upload-image-home"
                  feature="b9"
                  listImages={layout.b9}
                />
              </div>
            </div>
          </div>
        ...
        <div className="w-50">
          <div className="form-group--left">
            <div className="background-content">
              <label>
                Logo footer | <span className="highlight">530</span>px x{' '}
                <span className="highlight">285</span>px
              </label>
              <div className="form-group--nest">
                <ImageUploadSingle
